...
def record_compression_fallback_compile(message: str) -> None:
...
def read_active_compression_settings_compile() -> dict[str, Any]:
...
def format_compression_summary_lines_compile() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_compile()
    lines: list[str] = []
