...
def record_compression_fallback_flaky(message: str) -> None:
...
def read_active_compression_settings_flaky() -> dict[str, Any]:
...
def format_compression_summary_lines_flaky() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_flaky()
    lines: list[str] = []
