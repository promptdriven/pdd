...
def record_compression_fallback_exception(message: str) -> None:
...
def read_active_compression_settings_exception() -> dict[str, Any]:
...
def format_compression_summary_lines_exception() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_exception()
    lines: list[str] = []
