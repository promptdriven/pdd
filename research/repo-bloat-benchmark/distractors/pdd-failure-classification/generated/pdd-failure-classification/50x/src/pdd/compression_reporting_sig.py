...
def record_compression_fallback_sig(message: str) -> None:
...
def read_active_compression_settings_sig() -> dict[str, Any]:
...
def format_compression_summary_lines_sig() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_sig()
    lines: list[str] = []
