...
def record_compression_fallback_assertion(message: str) -> None:
...
def read_active_compression_settings_assertion() -> dict[str, Any]:
...
def format_compression_summary_lines_assertion() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_assertion()
    lines: list[str] = []
