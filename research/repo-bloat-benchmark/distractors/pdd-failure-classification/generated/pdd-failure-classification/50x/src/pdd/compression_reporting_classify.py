...
def record_compression_fallback_classify(message: str) -> None:
...
def read_active_compression_settings_classify() -> dict[str, Any]:
...
def format_compression_summary_lines_classify() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_classify()
    lines: list[str] = []
