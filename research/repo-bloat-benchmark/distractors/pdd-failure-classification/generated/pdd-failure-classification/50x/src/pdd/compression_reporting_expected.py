...
def record_compression_fallback_expected(message: str) -> None:
...
def read_active_compression_settings_expected() -> dict[str, Any]:
...
def format_compression_summary_lines_expected() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_expected()
    lines: list[str] = []
