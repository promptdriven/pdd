...
def record_compression_fallback_extract(message: str) -> None:
...
def read_active_compression_settings_extract() -> dict[str, Any]:
...
def format_compression_summary_lines_extract() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_extract()
    lines: list[str] = []
