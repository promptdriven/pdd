...
def record_compression_fallback_group(message: str) -> None:
...
def read_active_compression_settings_group() -> dict[str, Any]:
...
def format_compression_summary_lines_group() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_group()
    lines: list[str] = []
