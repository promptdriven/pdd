...
def record_compression_fallback_lower(message: str) -> None:
...
def read_active_compression_settings_lower() -> dict[str, Any]:
...
def format_compression_summary_lines_lower() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_lower()
    lines: list[str] = []
