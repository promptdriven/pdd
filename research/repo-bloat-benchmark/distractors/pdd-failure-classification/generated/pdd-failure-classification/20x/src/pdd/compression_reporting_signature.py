...
def record_compression_fallback_signature(message: str) -> None:
...
def read_active_compression_settings_signature() -> dict[str, Any]:
...
def format_compression_summary_lines_signature() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_signature()
    lines: list[str] = []
