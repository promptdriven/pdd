...
def record_compression_fallback_line(message: str) -> None:
...
def read_active_compression_settings_line() -> dict[str, Any]:
...
def format_compression_summary_lines_line() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_line()
    lines: list[str] = []
