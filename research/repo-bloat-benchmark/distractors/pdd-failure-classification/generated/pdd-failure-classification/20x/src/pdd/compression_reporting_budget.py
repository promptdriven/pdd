...
def record_compression_fallback_budget(message: str) -> None:
...
def read_active_compression_settings_budget() -> dict[str, Any]:
...
def format_compression_summary_lines_budget() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_budget()
    lines: list[str] = []
