...
def record_compression_fallback_pytest(message: str) -> None:
...
def read_active_compression_settings_pytest() -> dict[str, Any]:
...
def format_compression_summary_lines_pytest() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_pytest()
    lines: list[str] = []
