...
def record_compression_fallback_len(message: str) -> None:
...
def read_active_compression_settings_len() -> dict[str, Any]:
...
def format_compression_summary_lines_len() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_len()
    lines: list[str] = []
