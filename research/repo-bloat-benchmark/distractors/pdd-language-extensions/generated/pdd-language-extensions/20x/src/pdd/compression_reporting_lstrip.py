...
def record_compression_fallback_lstrip(message: str) -> None:
...
def read_active_compression_settings_lstrip() -> dict[str, Any]:
...
def format_compression_summary_lines_lstrip() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_lstrip()
    lines: list[str] = []
