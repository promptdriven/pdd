...
def record_compression_fallback_leading(message: str) -> None:
...
def read_active_compression_settings_leading() -> dict[str, Any]:
...
def format_compression_summary_lines_leading() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_leading()
    lines: list[str] = []
