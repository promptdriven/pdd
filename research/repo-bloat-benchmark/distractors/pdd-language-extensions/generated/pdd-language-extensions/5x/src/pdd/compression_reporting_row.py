...
def record_compression_fallback_row(message: str) -> None:
...
def read_active_compression_settings_row() -> dict[str, Any]:
...
def format_compression_summary_lines_row() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_row()
    lines: list[str] = []
