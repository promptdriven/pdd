...
def record_compression_fallback_reader(message: str) -> None:
...
def read_active_compression_settings_reader() -> dict[str, Any]:
...
def format_compression_summary_lines_reader() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_reader()
    lines: list[str] = []
