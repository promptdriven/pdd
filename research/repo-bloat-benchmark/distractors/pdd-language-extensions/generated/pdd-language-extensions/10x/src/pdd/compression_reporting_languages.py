...
def record_compression_fallback_languages(message: str) -> None:
...
def read_active_compression_settings_languages() -> dict[str, Any]:
...
def format_compression_summary_lines_languages() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_languages()
    lines: list[str] = []
