...
def record_compression_fallback_str(message: str) -> None:
...
def read_active_compression_settings_str() -> dict[str, Any]:
...
def format_compression_summary_lines_str() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_str()
    lines: list[str] = []
