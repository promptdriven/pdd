...
def record_compression_fallback_but(message: str) -> None:
...
def read_active_compression_settings_but() -> dict[str, Any]:
...
def format_compression_summary_lines_but() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_but()
    lines: list[str] = []
