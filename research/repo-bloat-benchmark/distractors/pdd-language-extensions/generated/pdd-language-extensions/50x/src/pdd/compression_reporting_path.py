...
def record_compression_fallback_path(message: str) -> None:
...
def read_active_compression_settings_path() -> dict[str, Any]:
...
def format_compression_summary_lines_path() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_path()
    lines: list[str] = []
