...
def record_compression_fallback_makefile(message: str) -> None:
...
def read_active_compression_settings_makefile() -> dict[str, Any]:
...
def format_compression_summary_lines_makefile() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_makefile()
    lines: list[str] = []
