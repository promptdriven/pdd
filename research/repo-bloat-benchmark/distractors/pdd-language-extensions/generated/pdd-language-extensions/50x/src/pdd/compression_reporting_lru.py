...
def record_compression_fallback_lru(message: str) -> None:
...
def read_active_compression_settings_lru() -> dict[str, Any]:
...
def format_compression_summary_lines_lru() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_lru()
    lines: list[str] = []
