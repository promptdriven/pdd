...
def record_compression_fallback_map(message: str) -> None:
...
def read_active_compression_settings_map() -> dict[str, Any]:
...
def format_compression_summary_lines_map() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_map()
    lines: list[str] = []
