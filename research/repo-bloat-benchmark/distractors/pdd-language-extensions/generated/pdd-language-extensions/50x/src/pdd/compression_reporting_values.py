...
def record_compression_fallback_values(message: str) -> None:
...
def read_active_compression_settings_values() -> dict[str, Any]:
...
def format_compression_summary_lines_values() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_values()
    lines: list[str] = []
