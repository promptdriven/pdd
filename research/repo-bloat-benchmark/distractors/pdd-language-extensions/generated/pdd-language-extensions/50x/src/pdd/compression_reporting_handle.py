...
def record_compression_fallback_handle(message: str) -> None:
...
def read_active_compression_settings_handle() -> dict[str, Any]:
...
def format_compression_summary_lines_handle() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_handle()
    lines: list[str] = []
