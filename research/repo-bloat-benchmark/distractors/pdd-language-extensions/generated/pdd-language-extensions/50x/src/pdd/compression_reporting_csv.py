...
def record_compression_fallback_csv(message: str) -> None:
...
def read_active_compression_settings_csv() -> dict[str, Any]:
...
def format_compression_summary_lines_csv() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_csv()
    lines: list[str] = []
