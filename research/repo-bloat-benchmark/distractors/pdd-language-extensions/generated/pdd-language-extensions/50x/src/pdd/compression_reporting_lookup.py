...
def record_compression_fallback_lookup(message: str) -> None:
...
def read_active_compression_settings_lookup() -> dict[str, Any]:
...
def format_compression_summary_lines_lookup() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_lookup()
    lines: list[str] = []
