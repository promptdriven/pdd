...
def record_compression_fallback_open(message: str) -> None:
...
def read_active_compression_settings_open() -> dict[str, Any]:
...
def format_compression_summary_lines_open() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_open()
    lines: list[str] = []
