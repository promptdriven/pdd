...
def record_compression_fallback_fence(message: str) -> None:
...
def read_active_compression_settings_fence() -> dict[str, Any]:
...
def format_compression_summary_lines_fence() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_fence()
    lines: list[str] = []
