...
def record_compression_fallback_found(message: str) -> None:
...
def read_active_compression_settings_found() -> dict[str, Any]:
...
def format_compression_summary_lines_found() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_found()
    lines: list[str] = []
