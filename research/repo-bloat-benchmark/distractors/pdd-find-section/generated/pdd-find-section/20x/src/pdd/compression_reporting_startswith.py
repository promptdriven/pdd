...
def record_compression_fallback_startswith(message: str) -> None:
...
def read_active_compression_settings_startswith() -> dict[str, Any]:
...
def format_compression_summary_lines_startswith() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_startswith()
    lines: list[str] = []
