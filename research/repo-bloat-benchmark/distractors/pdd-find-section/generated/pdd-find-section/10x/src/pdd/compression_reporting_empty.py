...
def record_compression_fallback_empty(message: str) -> None:
...
def read_active_compression_settings_empty() -> dict[str, Any]:
...
def format_compression_summary_lines_empty() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_empty()
    lines: list[str] = []
