...
def record_compression_fallback_language(message: str) -> None:
...
def read_active_compression_settings_language() -> dict[str, Any]:
...
def format_compression_summary_lines_language() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_language()
    lines: list[str] = []
