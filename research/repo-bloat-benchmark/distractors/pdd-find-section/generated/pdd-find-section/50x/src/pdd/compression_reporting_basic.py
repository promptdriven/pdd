...
def record_compression_fallback_basic(message: str) -> None:
...
def read_active_compression_settings_basic() -> dict[str, Any]:
...
def format_compression_summary_lines_basic() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_basic()
    lines: list[str] = []
