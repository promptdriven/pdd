...
def record_compression_fallback_sub(message: str) -> None:
...
def read_active_compression_settings_sub() -> dict[str, Any]:
...
def format_compression_summary_lines_sub() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_sub()
    lines: list[str] = []
