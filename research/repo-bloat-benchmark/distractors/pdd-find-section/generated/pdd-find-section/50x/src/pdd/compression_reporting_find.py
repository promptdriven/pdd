...
def record_compression_fallback_find(message: str) -> None:
...
def read_active_compression_settings_find() -> dict[str, Any]:
...
def format_compression_summary_lines_find() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_find()
    lines: list[str] = []
