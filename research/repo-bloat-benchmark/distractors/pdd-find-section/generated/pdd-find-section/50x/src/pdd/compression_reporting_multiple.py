...
def record_compression_fallback_multiple(message: str) -> None:
...
def read_active_compression_settings_multiple() -> dict[str, Any]:
...
def format_compression_summary_lines_multiple() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_multiple()
    lines: list[str] = []
