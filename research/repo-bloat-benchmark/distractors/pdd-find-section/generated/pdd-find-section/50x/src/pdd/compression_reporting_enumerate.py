...
def record_compression_fallback_enumerate(message: str) -> None:
...
def read_active_compression_settings_enumerate() -> dict[str, Any]:
...
def format_compression_summary_lines_enumerate() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_enumerate()
    lines: list[str] = []
