...
def record_compression_fallback_blocks(message: str) -> None:
...
def read_active_compression_settings_blocks() -> dict[str, Any]:
...
def format_compression_summary_lines_blocks() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_blocks()
    lines: list[str] = []
