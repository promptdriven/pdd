...
def record_compression_fallback_start(message: str) -> None:
...
def read_active_compression_settings_start() -> dict[str, Any]:
...
def format_compression_summary_lines_start() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_start()
    lines: list[str] = []
