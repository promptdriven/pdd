...
def record_compression_fallback_pop(message: str) -> None:
...
def read_active_compression_settings_pop() -> dict[str, Any]:
...
def format_compression_summary_lines_pop() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_pop()
    lines: list[str] = []
