...
def record_compression_fallback_append(message: str) -> None:
...
def read_active_compression_settings_append() -> dict[str, Any]:
...
def format_compression_summary_lines_append() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_append()
    lines: list[str] = []
