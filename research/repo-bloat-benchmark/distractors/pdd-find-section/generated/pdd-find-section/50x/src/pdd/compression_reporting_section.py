...
def record_compression_fallback_section(message: str) -> None:
...
def read_active_compression_settings_section() -> dict[str, Any]:
...
def format_compression_summary_lines_section() -> list[str]:
    """Lines for the command execution summary."""
    settings = read_active_compression_settings_section()
    lines: list[str] = []
