...
_CONFIG_HEADER = (
    ...
    "(design §8.1.1).\n"
    "# Key names are best-effort until the Codex CLI build is pinned "
    "(design §10); the\n"
    "# env fingerprint covers this file, so any adjustment is a new "
...
class FreezeConfig:
    ...
    def render_config(self, proxy_base_url: str) -> str:
        ...
        lines.append(f"web_search = {str(self.web_search_enabled).lower()}")
