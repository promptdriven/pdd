...
- `pdd detect --stories` runs the validation suite. It classifies every criterion in a story's contract against the linked prompts and reports each one individually:
