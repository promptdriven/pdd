...
In both modes, warnings are printed for any dynamic tags (`<shell>`, `<web>`, semantic `query=` includes) that were detected but not expanded (nondeterministic, deferred).
