...
- `--adversarial-prompt TEXT`: Adversarial instruction forwarded to all reviewers in `--agentic-review-loop` mode (default: `"find reasons not to merge the PR"`). Propagated verbatim to each reviewer and to the fresh final reviewer.
