...
- input_tokens: The actual input token count when reported by the command result; blank when unavailable.
- output_tokens: The actual output token count when reported by the command result; blank when unavailable.
