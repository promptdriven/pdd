...
def main():
    script_path = Path(__file__).parent / "pdd_intro_tts_script.md"
    output_dir = Path(__file__).parent / "tts-output"
    ...
    model_path = Path(__file__).parent / "models" / "Qwen3-TTS-12Hz-1.7B-CustomVoice"
