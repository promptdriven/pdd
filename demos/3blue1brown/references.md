...
- **Hong et al. / Chroma** — "Context Rot: Understanding the Loss of LLM Capability as Context Grows" (2025)
  https://research.trychroma.com/context-rot
  *Key finding: Across 18 leading LLMs, model performance degrades as input context length grows. Models lose accuracy, hallucinate more, and miss relevant information in longer contexts. This explains why AI tools help less on large codebases—the context window can't keep up.*
