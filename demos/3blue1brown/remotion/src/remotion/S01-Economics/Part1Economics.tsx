...
export const Part1Economics: React.FC<Part1EconomicsPropsType> = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a1a" }}>
      ...
      {/* Visual 0: SockPriceChart - Sock economics: nostalgia → economics → 1950 → fli */}
      {activeVisual === 0 && (
      ...
      {/* Visual 1: CodeCostChart - Code economics: look at code → expensive → patched */}
      {activeVisual === 1 && (
      ...
      {/* Visual 2: CodeCostChart - AI enters: interesting → faster → cursor/claude →  */}
      {activeVisual === 2 && (
      ...
      {/* Visual 3: CrossingPoint - Reveal: dashed line → debt → accumulates → 60% spe */}
      {activeVisual === 3 && (
      ...
      {/* Visual 4: ContextRot - Context rot: something else → small=brilliant → wi */}
      {activeVisual === 4 && (
      ...
      {/* Visual 5: DeveloperEditZoomout - Regeneration: doesn't have problem → fits window → */}
      {activeVisual === 5 && (
      ...
      {/* Visual 6: Veo clip - Best darning needles: cursor/claude → fantastic →  */}
      {activeVisual === 6 && (
        <AbsoluteFill>
          <OffthreadVideo
      ...
      {/* Visual 7: PieChart - Maintenance costs: 80-90% → maintaining → compound */}
      {activeVisual === 7 && (
      ...
      {/* Visual 8: PartsEject - Paradigm shift: what changed → mold once → unlimit */}
      {activeVisual === 8 && (
      ...
      {/* Visual 9: ValueAura - Fix the mold → every part → real shift → where val */}
      {activeVisual === 9 && (
