...
export const BEATS = {
  // Visual 0: veo:07_split_screen_sepia — "If you use cursor or clawed code or copilot, you'r..."
  VISUAL_00_START: s2f(0.0),  // 0 frames
  VISUAL_00_END: s2f(4.92),  // 148 frames

  // Visual 1: veo:07_split_screen_sepia — "But here's what your great-grandmother figured out..."
  VISUAL_01_START: s2f(5.24),  // 157 frames
  VISUAL_01_END: s2f(7.72),  // 232 frames

  // Visual 2: veo:07_split_screen_sepia — "60 years ago, when Sox got cheap enough, she stopp..."
  VISUAL_02_START: s2f(8.26),  // 248 frames
  VISUAL_02_END: s2f(12.5),  // 375 frames

  // Visual 3: veo:07_split_screen_sepia — "Code just got that cheap...."
  VISUAL_03_START: s2f(12.78),  // 383 frames
  VISUAL_03_END: s2f(13.76),  // 413 frames

  // Visual 4: veo:07_split_screen_sepia — "So why are we still patching?..."
...
export const VISUAL_SEQUENCE = [
  { start: BEATS.VISUAL_00_START, end: BEATS.VISUAL_00_END, id: "veo:07_split_screen_sepia", desc: "If you use Cursor, Claude Code, Copilot, getting good" },
  { start: BEATS.VISUAL_01_START, end: BEATS.VISUAL_01_END, id: "veo:07_split_screen_sepia", desc: "Great-grandmother figured out sixty years ago" },
  { start: BEATS.VISUAL_02_START, end: BEATS.VISUAL_02_END, id: "veo:07_split_screen_sepia", desc: "When socks got cheap enough she stopped" },
  { start: BEATS.VISUAL_03_START, end: BEATS.VISUAL_03_END, id: "veo:07_split_screen_sepia", desc: "Code just got that cheap" },
  { start: BEATS.VISUAL_04_START, end: BEATS.VISUAL_04_END, id: "veo:07_split_screen_sepia", desc: "So why are we still patching" },
];
