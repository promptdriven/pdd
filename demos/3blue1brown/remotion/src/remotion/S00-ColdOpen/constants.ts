...
export const BEATS = {
  // Visual 0: ColdOpenSplitScreen — "If you use cursor or clawed code or copilot, you'r..."
  VISUAL_00_START: s2f(0.0),  // 0 frames
  VISUAL_00_END: s2f(4.92),  // 148 frames

  // Visual 1: ColdOpenSplitScreen — "But here's what your great-grandmother figured out..."
  VISUAL_01_START: s2f(5.24),  // 157 frames
  VISUAL_01_END: s2f(7.72),  // 232 frames

  // Visual 2: ColdOpenSplitScreen — "60 years ago, when Sox got cheap enough, she stopp..."
...
export const VISUAL_SEQUENCE = [
  { start: BEATS.VISUAL_00_START, end: BEATS.VISUAL_00_END, id: "ColdOpenSplitScreen", desc: "If you use Cursor, Claude Code, Copilot, getting good" },
  { start: BEATS.VISUAL_01_START, end: BEATS.VISUAL_01_END, id: "ColdOpenSplitScreen", desc: "Great-grandmother figured out sixty years ago" },
  { start: BEATS.VISUAL_02_START, end: BEATS.VISUAL_02_END, id: "ColdOpenSplitScreen", desc: "When socks got cheap enough she stopped" },
  { start: BEATS.VISUAL_03_START, end: BEATS.VISUAL_03_END, id: "ColdOpenSplitScreen", desc: "Code just got that cheap" },
  { start: BEATS.VISUAL_04_START, end: BEATS.VISUAL_04_END, id: "ColdOpenSplitScreen", desc: "So why are we still patching" },
];
