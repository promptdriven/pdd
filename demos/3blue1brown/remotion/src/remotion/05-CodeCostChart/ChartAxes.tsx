...
export const ChartAxes: React.FC<ChartAxesProps> = ({ opacity = 1 }) => {
  ...
  // Fade in animation after morph completes
  const fadeIn = interpolate(
    frame,
    [BEATS.AXES_VISIBLE_START, BEATS.AXES_VISIBLE_END],
    [0, 1],
  ...
  // Year ticks for 1970-2024 range
  const yearTicks = [1970, 1980, 1990, 2000, 2010, 2020, 2024];
