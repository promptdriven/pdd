...
REFERENCE_IMAGES = {
    "left": "../../references/cold-open/developer_reference.png",
    "right": "../../references/cold-open/grandmother_reference.png",
}
...
SEGMENTS = {
    "01a": {
        ...
        "left_prompt": "../../specs/00-cold-open/prompts/01a_left_developer.md",
        "right_prompt": "../../specs/00-cold-open/prompts/01a_right_grandmother.md",
    },
    "01b": {
        "name": "synchronized_completion",
        "duration": 7,
        "file": "01b_synchronized_completion.md",
        "left_prompt": "../../specs/00-cold-open/prompts/01b_left_developer.md",
        "right_prompt": "../../specs/00-cold-open/prompts/01b_right_grandmother.md",
    },
    "01c": {
        "name": "brief_satisfaction",
        "duration": 3,
        "file": "01c_brief_satisfaction.md",
        "left_prompt": "../../specs/00-cold-open/prompts/01c_left_developer.md",
        "right_prompt": "../../specs/00-cold-open/prompts/01c_right_grandmother.md",
    },
    "01d": {
        "name": "zoom_out_reveal",
        "duration": 14,
        "file": "01d_zoom_out_reveal.md",
        "left_prompt": "../../specs/00-cold-open/prompts/01d_left_developer.md",
        "right_prompt": "../../specs/00-cold-open/prompts/01d_right_grandmother.md",
    },
    "01e": {
...
def main():
    ...
    output_dir = project_root / "outputs" / "veo" / "00-cold-open" / "raw"
    ...
    frames_dir = project_root / "outputs" / "veo" / "00-cold-open" / "frames"
