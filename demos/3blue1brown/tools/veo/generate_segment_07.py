...
Reference Frames:
    ...
    - outputs/veo/00-cold-open/frames/01e_left_last.png (developer)
    - outputs/veo/00-cold-open/frames/01e_right_last.png (grandmother)
...
REFS_DIR = PROJECT_ROOT / "references" / "part-1"
OUTPUTS_DIR = PROJECT_ROOT / "outputs" / "veo" / "01-economics" / "raw"
COMPOSITED_DIR = PROJECT_ROOT / "outputs" / "veo" / "01-economics" / "composited"
FRAMES_DIR = PROJECT_ROOT / "outputs" / "veo" / "01-economics" / "frames"

# Cold open frames directory (source for character consistency)
COLD_OPEN_FRAMES_DIR = PROJECT_ROOT / "outputs" / "veo" / "00-cold-open" / "frames"
...
def generate_videos(client, use_custom_refs: bool = False):
    ...
    if not left_ref_path or not right_ref_path:
        ...
        print("  Expected cold open frames at: outputs/veo/00-cold-open/frames/01e_*_last.png")
