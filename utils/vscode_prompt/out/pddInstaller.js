...
class PddInstaller {
    ...
    async checkAndPromptInstallation() {
        try {
            ...
            if (!installed) {
                const choice = await vscode.window.showInformationMessage('PDD CLI is not installed. Would you like to install it automatically?', 'Install PDD CLI', 'Not Now', "Don't Ask Again");
