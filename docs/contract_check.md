...
- **All local verifier subcommands:** see [docs/checkup_verifier.md](checkup_verifier.md).
- **Prompt coaching (Mode B):** see [docs/checkup_prompt_coaching.md](checkup_prompt_coaching.md).
