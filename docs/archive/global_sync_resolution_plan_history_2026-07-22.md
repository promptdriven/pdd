# Archived Global Sync Resolution Plan (2026-07-22)

This file preserves the former combined execution plan, incident ledger, and
certificate specification for evidence lineage. It is not executable and must
not be used to select current work, release vehicles, or blockers. The active
plan is `docs/global_sync_resolution_plan.md`.
