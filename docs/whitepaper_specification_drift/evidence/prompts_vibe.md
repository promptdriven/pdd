...
>       - Worktree: <LOCAL_WORKSPACE>/pdd_cloud/.claude/worktrees/fix-issue-504
...
>     ⏺ https://github.com/promptdriven/pdd_cloud/pull/524 is this in seperate   <LOCAL_WORKSPACE>/pdd_cloud/.claude/worktrees/fix-524/extensions/github_pdd_app/
...
>     what if i did this cd <LOCAL_WORKSPACE>/pdd_cloud/.claude/worktrees/fix-issue-504
...
>     Cloud Logging: [REDACTED-CLOUD-CONSOLE-URL]
...
>     - Path: <LOCAL_WORKSPACE>/pdd-gltanaka
...
>     pwd: <LOCAL_WORKSPACE>/pdd-gltanaka
...
>     (base) serhanasad@Serhans-Laptop fix-670-clean % cd ~/Desktop/SF/pdd_cloud/.pdd/worktrees/fix-670-clean && STAGING_PROJECT=[REDACTED-GCP-PROJECT] PYTHONPATH=. .backend/functions/venv/bin/activate && PYTHONUNBUFFERED=1 python -m scripts.cloud_batch.run_cloud_tests
...
>     [REDACTED-INFRA-URL] my pr got merged can you see if its in prod deployed if i can test now
...
>     (base) serhanasad@Serhans-Laptop fix-659-clean % cd <LOCAL_WORKSPACE>/pdd_cloud/.pdd/worktrees/fix-659-clean && PYTHONUNBUFFERED=1 <LOCAL_WORKSPACE>/pdd_cloud/backend/functions/venv/bin/python3 -m scripts.cloud_batch.run_cloud_tests
>     <LOCAL_WORKSPACE>/pdd_cloud/backend/functions/venv/bin/python3: Error while finding module specification for 'scripts.cloud_batch.run_cloud_tests' (ModuleNotFoundError: No module named 'scripts')
