...
def test_resolve_model_for_tier_uses_deepswe_manifest():
    ...
    assert resolve_model_for_tier(1, provider="openai") == "gpt-5.6-sol"
    assert resolve_model_for_tier(2, provider="CODEX") == "gpt-5.4"
    assert resolve_model_for_tier(1, provider="anthropic") is None
    assert resolve_model_for_tier(2, provider="anthropic") is None
    assert resolve_model_for_tier(3, provider="anthropic") == "claude-opus-4-7"
    assert resolve_model_for_tier(3, provider="openai") is None
    assert resolve_model_for_tier(5, provider="google") == "gemini-3.5-flash"
    assert resolve_model_for_tier(1, provider="google") is None
    assert resolve_model_for_tier(1, provider="opencode") is None
