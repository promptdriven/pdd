...
def test_routes_module_exports():
    ...
    with patch.dict(sys.modules, module_patches):
        ...
        expected_all = ["architecture", "auth", "config", "extracts", "files", "commands", "prompts", "observability", "deployments", "architecture_router", "auth_router", "config_router", "extracts_router", "files_router", "commands_router", "websocket_router", "prompts_router", "create_observability_router", "create_deployments_router"]
