...
- **sync**: honor contained `architecture.json.filepath` mappings for nested or custom `.pddrc` prompt roots while keeping prompt discovery context-safe and bounded (#1976).
