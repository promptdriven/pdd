...
- Enhance agentic architecture and bug workflows, update documentation, and remove obsolete module entries.
- Initialize new experiment run 18 for user ID parser with baseline implementation, prompts, and acceptance tests, and update experiment results for run 17.
- add new scripts and experiment runs for replay stability A/B testing and update 3Blue1Brown demo audit specs.
- Introduce new experimental runs (run_14, run_15) for the user ID parser, including new tests for various input types and updated experiment metrics.
...
- add demo script for process_csv_change usage
- update TODO with whitepaper enhancement on code generation
- add collaboration model comparison diagram to whitepaper
- add fundamental PDD unit section to whitepaper
- add workflow diagram to whitepaper on Prompt-Driven Development
- implement cross-platform timestamp modification in regression script
- add whitepaper on Prompt-Driven Development methodology
- update batch output file handling in main example script
- enhance semantic error handling in regression script
- refine main example script for improved clarity and functionality
- update verification process in regression script
- improve regression directory handling in regression script
- enhance crash command handling in regression script
- enhance change_main function for improved CSV processing and output handling
- introduce prompt-driven development methodology documentation
- enhance change_main function for improved CSV handling and error reporting
- add simple math prompt and update regression script paths
- enhance change_main example and error handling for CSV mode
- enhance output handling in change_main for directory and CSV saving
- improve individual file saving and logging in change_main
- enhance Makefile and add new context files for simple_math
- add comprehensive tests for error handling in verification loop
- implement isolated verification harness and refactor verification command
- enhance README with new command overview and enhancement phase
- update prompt extraction instructions for LLM outputs
- improve language handling in bug_main and bug_to_unit_test
- enhance language detection and validation in construct_paths
- implement verification workflow in regression tests
- enhance language detection for 'detect' and 'change' commands
- add comprehensive testing for 'fix' command with real files
- add real command testing for 'generate' functionality
- enhance CLI error handling and command testing
- enhance error handling and command execution in CLI
- introduce minimal CLI demo for PDD usage
- add `verify` command to enhance code verification process
- enhance crash_main functionality and error handling
- add demo script for construct_paths usage and enhance path handling
- enhance output path generation and documentation
- enhance error fixing process with XML logging and program code output
- enhance Makefile with new generate and crash targets
- implement fix_verification_main function and example script
- add new prompt for verify_main function implementation
- add comprehensive test suite for fix_verification_errors_loop
- expand test coverage for fix_verification_errors function
- add program_args parameter to enhance subprocess execution
- update verification logging and enhance function parameters
- enhance fix_verification_errors_loop with improved error handling and logging
...
- Add `--paginate` to `gh api` commands to correctly fetch all comments, resolving workflow state loss for issues with over 30 comments (Issue #481).
...
- ignore .pyc files
- add --list-contexts cli test
- add text (.txt) language generation support
- requirements.txt for pytest
- **docs**: clean formatting in SETUP_WITH_GEMINI.md
...
- enhance error handling for LLM analysis and file editing
- improve error handling for Rich markup in CLI and LLM invoke
- update file creation in regression tests to use printf for proper formatting
- correct output file references in regression script for CSV handling
- update default parameters and rename prompt files in regression script
- improve error handling and command output in CLI
- adjust strength parameter in continue_generation function for consistency
- adjust default strength and enhance error message handling in tests
- update Makefile and crash handling for improved output structure
- correct XML attribute handling and update test assertions in fix_verification_errors_loop
- update test assertions and logging in test_fix_verification_errors_loop
- clarify variable documentation and improve loop logic in fix_verification_errors_loop
- update test suite for fix_verification_errors_loop with improved assertions and logging
- update model name in tests to reflect new configuration
- update llm_model.csv and regression_analysis_log.prompt for accuracy
- update version from 0.1.0 to 0.0.23
...
- Correct easing function names and adjust frame interpolation in Remotion components, update ColdOpenSection content and layout, and add a `.gitkeep` file.
...
- update TODO list with new tasks and reintroduce Python 3.13 support
- update LLM configurations and improve output handling
- update pytest configuration and enhance TODO list
- enhance error handling and return types in CLI commands
- enhance CLI functionality and test coverage
- enhance CSV processing and error handling in change_main function
- enhance error handling and CSV processing in change_main function
- update return structure and enhance test coverage for fix_errors_from_unit_tests
- normalize output path handling in change_main function
- update strength parameter in fix_errors_from_unit_tests function
- enhance CSV validation and error handling in change_main function
- enhance error handling and logging in fix_errors_from_unit_tests
- enhance error handling and logging in change_main function
- improve error messages and assertions in test_change_main
- add max_iterations parameter to error fixing functions
- enhance argument parsing, file handling, and error management in change_main_python.prompt
- remove debug print statements from error handling in unit tests and main fix process
- enhance test structure and file handling in test_process_csv_change
- improve CSV header validation and processing logic in process_csv_change
- enhance CSV processing and error handling in process_csv_change
- enhance CSV processing and prompt handling in process_csv_change
- simplify output path handling in CLI commands
- streamline output handling in CLI commands
- enhance change_main and process_csv_change for improved functionality
- update default parameters in test fixtures for verification
- improve file handling and error management in verification process
- update context object assignment in dummy context creation
- enhance test coverage and error handling in fix_main
- allow non-existent error file for loop mode in CLI
- streamline regression script setup and context management
- update regression analysis prompts for improved file search
- enhance cost tracking and validation in regression tests
- enforce error file existence and enhance error handling
- enhance change_main function with mock compatibility and error handling
- update requirements and add new whitepaper on Prompt-Driven Development
- update TODO and enhance whitepaper with PDD comparison
- enhance whitepaper with updated synchronization strategies
- update LLM models in langchain_lcel_example.py
- enhance whitepaper with key principle on test accumulation
- improve regression analysis process in Makefile
- enhance whitepaper with updated collaboration model and visual representation
- update whitepaper to reflect interactive AI-assisted development and versioned prompts
- update collaboration model diagram and description in whitepaper
- remove redundant section and add new diagrams to whitepaper
- update workflow diagram in whitepaper for clarity and accuracy
- update scraping method and response handling in firecrawl_example and preprocess
- consolidate global settings and logging in regression script
- streamline CLI tests by directly invoking core functions
- standardize return order in split and split_main functions
- replace hardcoded strength values with DEFAULT_STRENGTH constant
- standardize strength parameter across the codebase
- enhance error handling and logging in fix_code_loop function
- enhance crash handling and output structure in Makefile and related scripts
- enhance error handling and logging in fix_verification_errors function
