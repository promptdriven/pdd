...
*   **Side-Effect Policy Enforcement**: Use ``pdd checkup policy check`` to ensure your code adheres to security and capability constraints defined in your prompts (e.g., forbidding unauthorized network or shell access).
...
.. code-block:: console
   ...
   pdd checkup policy check src/payment_processor.py --prompt prompts/payment_processor_python.prompt
