...
const PREVIEW_VISUAL_CONTRACTS: Record<string, Record<string, unknown> | null> = {
  ...
  "cold_open:07_pdd_title_card": {"specBaseName": "07_pdd_title_card", "dataPoints": {"type": "title_card", "sectionNumber": 0, "sectionLabel": null, "titleLine1": "Prompt-Driven", "titleLine2": "Development", "titleColor": "#4A90D9", "subtitle": "Writing the mold, not the plastic.", "subtitleColor": "#94A3B8", "backgroundColor": "#0D1117", "codeUnderlayOpacity": 0.04, "glow": {"blur": 12, "color": "#4A90D9", "opacity": 0.08}, "terminalBreadcrumb": "pdd generate", "narrationSegments": ["cold_open_006"]}, "overlayConfig": null, "renderMode": "component"},
