...
Segments: `part3_mold_has_three_parts_003`, `part3_mold_has_three_parts_004`

- **0:14** ("prompt is the mold"): Mold outline begins drawing
- **0:22** ("three components"): Regions begin highlighting one by one
- **0:28** ("Three types of capital"): Subtitle appears, all regions active
...
```json
{
  ...
  "narrationSegments": ["part3_mold_has_three_parts_003", "part3_mold_has_three_parts_004"]
}
```
