...
Segments: `part3_mold_has_three_parts_005`, `part3_mold_has_three_parts_006`

- **0:30** ("First: tests"): Walls begin illuminating with labels
- **0:36** ("Each test is a constraint"): Liquid begins flowing, hitting walls
...
```json
{
  ...
  "narrationSegments": ["part3_mold_has_three_parts_005", "part3_mold_has_three_parts_006"]
}
```
