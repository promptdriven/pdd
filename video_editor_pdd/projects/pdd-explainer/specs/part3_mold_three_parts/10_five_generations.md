...
Segment: `part3_mold_three_parts_017`

- **2:42** ("LLMs don't follow instructions"): Five panels slide in
- **2:50** ("doesn't need perfection"): Red X and yellow warnings appear
- **2:55** ("Pick the one"): Green checkmark blooms on panel 5
...
```json
{
  ...
  "narrationSegments": ["part3_mold_three_parts_017"]
}
```
