...
> "And the prompt doesn't define the walls—tests do that. The prompt defines what you're asking for and why."
> "Notice something subtle: the exact implementation can vary. What's locked is the behavior."

Segments: `part3_mold_three_parts_020`, `part3_mold_three_parts_021`, `part3_mold_three_parts_022`

- **3:50** ("Second, the prompt"): Nozzle highlights, labels appear
- **3:54** ("prompt doesn't define the walls"): Text flows into cavity
- **4:03** ("exact implementation can vary"): Dual generation shown
...
```json
{
  ...
  "narrationSegments": ["part3_mold_three_parts_020", "part3_mold_three_parts_021", "part3_mold_three_parts_022"]
}
```
