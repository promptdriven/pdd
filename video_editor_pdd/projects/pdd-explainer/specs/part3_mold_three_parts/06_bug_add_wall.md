...
## Narration Sync
> "And watch what happens when you find a bug..."
> "So you don't patch the code. You add a wall."
> "That wall is permanent! That bug can never occur again—not in this generation, not in any future generation."

Segments: `part3_mold_three_parts_011`, `part3_mold_three_parts_012`, `part3_mold_three_parts_013`

- **1:52** ("watch what happens"): Bug highlight flashes on code
- **1:54** ("don't patch the code"): New wall materializes in mold
- **1:57** ("wall is permanent"): Code regenerates, wall glows
...
```json
{
  ...
  "narrationSegments": ["part3_mold_three_parts_011", "part3_mold_three_parts_012", "part3_mold_three_parts_013"]
}
```
