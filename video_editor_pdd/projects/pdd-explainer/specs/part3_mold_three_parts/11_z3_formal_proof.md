...
4. **Frame 270-450 (9-15s):** Main annotation text fades in, word by word or line by line.
5. **Frame 450-570 (15-19s):** "Not sampling. Mathematical proof." appears with emphasis pulse.
6. **Frame 570-720 (19-24s):** Hold. Domain label fades in. Everything subtly pulses.
...
Segment: `part3_mold_three_parts_018`

- **3:00** ("some of those walls aren't just tested"): Chip die and Z3 module appear
- **3:10** ("PDD uses Z3"): Equivalence connector appears, annotation text
- **3:18** ("Not sampling. Mathematical proof."): Emphasis line pulses
...
```json
{
  ...
  "narrationSegments": ["part3_mold_three_parts_018"]
}
```
