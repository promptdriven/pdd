...
7. **Frame 200-424 (6.67-14s):** Hold. Subtle overall pulse on cross-section.
...
## Narration Sync
> "We're hitting the same wall that the chip industry hit forty years ago."
> "But Chip Industries' answer wasn't 'write the code better.' It was: stop writing the code."
> "And that same transition."

Segments: `part3_mold_three_parts_001`, `part3_mold_three_parts_002`, `part3_mold_three_parts_003`

- **0:00** ("We're hitting the same wall"): Title card begins fade-in
- **1.50s** ("same wall"): "THE MOLD HAS" typing on screen
- **3.00s** ("stop writing the code"): "THREE PARTS" revealed
- **6.67s** ("And that same transition"): Three regions pulsing sequentially
...
```json
{
  ...
  "narrationSegments": ["part3_mold_three_parts_001", "part3_mold_three_parts_002", "part3_mold_three_parts_003"]
}
```
