...
6. **Frame 480-660 (16-22s):** Left panel dims to 0.3. Right panel brightens. The preference is clear.
7. **Frame 660-810 (22-27s):** Bottom statement appears. Hold.
...
Segment: `part3_mold_three_parts_024`

- **4:31** ("context window advantage"): Both panels begin filling
- **4:40** ("natural language"): Right panel prominent, left dimming
- **4:48** ("five to ten times"): "10×" multiplier appears
- **4:55** ("every token is author-curated"): Bottom statement
...
```json
{
  ...
  "narrationSegments": ["part3_mold_three_parts_024"]
}
```
