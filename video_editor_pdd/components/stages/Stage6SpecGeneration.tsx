                            ...
                            <tr className="border-t border-slate-700 bg-slate-800/70">
                              <td colSpan={4} className="p-3">
                                ...
                                >
                                  ...
                                  <div className="grid gap-3 xl:grid-cols-3" style={{ height: '420px' }}>
                                    <div className="flex min-h-0 min-w-0 flex-col overflow-hidden rounded border border-slate-700 bg-slate-900/60">
                                    ...
                                    <div className="flex min-h-0 min-w-0 flex-col overflow-hidden rounded border border-slate-700 bg-slate-900/60 p-3">
