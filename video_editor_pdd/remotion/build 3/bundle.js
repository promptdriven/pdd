...
;// ./src/remotion/_shared/load-inter-font.ts


const INTER_FONT_URL = (0,esm.staticFile)("fonts/InterVariable-latin.woff2");
const INTER_FONT_WEIGHTS = ["300", "400", "500", "600", "700", "900"];
const interFontHandle = typeof document !== "undefined" ? (0,esm.delayRender)("Loading Inter font") : null;
...
const finishFontLoad = () => {
  ...
  (0,esm.continueRender)(interFontHandle);
};
...
if (!hasStartedLoading) {
  ...
  void loadInterFont().catch(() => void 0).finally(finishFontLoad);
}


;// ./src/remotion/animation_section/index.tsx



const AnimationSectionSection = () => {
  const fps = 30;
  const offsetSeconds = 0;
  const durationSeconds = 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: Math.max(1, Math.ceil(durationSeconds * fps)), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: (0,esm.staticFile)("animation_section/narration.wav") }) });
};
/* harmony default export */ const animation_section = ((/* unused pure expression or super */ null && (AnimationSectionSection)));

;// ./src/remotion/veo_section/index.tsx



const VeoSectionSection = () => {
  const fps = 30;
  const offsetSeconds = 0;
  const durationSeconds = 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 0, durationInFrames: Math.max(1, Math.ceil(durationSeconds * fps)), children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: (0,esm.staticFile)("veo_section/narration.wav") }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.OffthreadVideo, { src: (0,esm.staticFile)("veo_section.mp4"), style: { width: "100%", height: "100%" } })
  ] });
};
/* harmony default export */ const veo_section = ((/* unused pure expression or super */ null && (VeoSectionSection)));
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(996), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 8996)).then(({ StudioInternals }) => {
