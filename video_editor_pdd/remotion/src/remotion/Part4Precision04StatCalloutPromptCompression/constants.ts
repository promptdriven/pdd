// Part4Precision04StatCalloutPromptCompression constants
...
// Card dimensions and position (right-aligned, vertically centered per spec)
export const CARD_X = 1080;
export const CARD_Y = 340;
export const CARD_WIDTH = 760;
export const CARD_HEIGHT = 340;
export const CARD_BORDER_RADIUS = 16;
export const CARD_BG = "rgba(15, 23, 42, 0.85)";
export const CARD_BORDER = "rgba(245, 158, 11, 0.3)";
export const CARD_GLOW = "0 8px 32px rgba(245, 158, 11, 0.2)";
...
export const DESCRIPTOR_TEXT = "token reduction with structured prompts";
export const SOURCE_TEXT = "PDD Benchmark, 2025";
export const QUALIFIER_TEXT = "vs. free-form instructions";

// Animation timing (frames at 30fps, total 240 = 8s)
...
export const SLIDE_OUT_END = 240;
