...
export const StatCalloutCard: React.FC = () => {
  ...
  // Stat "$2.41T" scale (0.8 → 1.0) and opacity
  ...
  // Detail row 1: "Technical debt is #1 driver" — slide from right + fade
  ...
  // Detail row 2: "Growing 15% year-over-year" — slide from right + fade
