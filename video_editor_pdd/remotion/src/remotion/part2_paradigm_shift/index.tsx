...
const COMPONENT_MAP: Record<string, React.ComponentType<any>> = {
  ...
  "02_double_meter_insight": Part1Economics10DoubleMeterInsight,
  "05_mold_defect_fix": Part2ParadigmShift04DefectFixTheMold,
...
const VISUAL_DURATIONS: Record<string, number> = {
  ...
  "02_double_meter_insight": 750,
  "05_mold_defect_fix": 420,
...
const VISUAL_MEDIA: Record<string, Record<string, string>> = {
  ...
  "08_mold_producing_parts": { defaultSrc: "veo/mold_glow_finale.mp4", backgroundSrc: "veo/mold_glow_finale.mp4", outputSrc: "veo/mold_glow_finale.mp4", baseSrc: "veo/mold_glow_finale.mp4" },
  "09_1980s_chip_lab": { defaultSrc: "veo/chip_design_1980s_lab.mp4", backgroundSrc: "veo/chip_design_1980s_lab.mp4", outputSrc: "veo/chip_design_1980s_lab.mp4", baseSrc: "veo/chip_design_1980s_lab.mp4" },
};
...
const VISUAL_CONTRACTS: Record<string, Record<string, unknown> | null> = {
  ...
  "03_factory_floor_intro": {"specBaseName": "03_factory_floor_intro", "dataPoints": {"type": "veo_clip", "clipId": "factory_floor_intro", "camera": {"framing": "wide_establishing", "movement": "slow_dolly_forward", "dof": "deep", "aperture": "f/5.6", "angle": "eye_level_to_low"}, "lighting": {"key": {"color": "#F0F0EC", "type": "overhead_fluorescent"}, "fill": {"color": "#FFB347", "opacity": 0.2, "type": "machinery_indicators"}, "accent": {"color": "#4A90D9", "opacity": 0.1, "type": "status_leds"}, "atmosphere": "light_haze"}, "narrationSegments": ["part2_paradigm_shift_005", "part2_paradigm_shift_006"]}, "mediaAliases": {"defaultSrc": "veo/factory_floor_intro.mp4", "backgroundSrc": "veo/factory_floor_intro.mp4", "outputSrc": "veo/factory_floor_intro.mp4", "baseSrc": "veo/factory_floor_intro.mp4"}, "overlayConfig": null, "renderMode": "raw-media"},
  "04_injection_molding_process": {"specBaseName": "04_injection_molding_process", "dataPoints": {"type": "veo_clip", "clipId": "injection_molding_process", "camera": {"framing": "extreme_close_up", "movement": "slow_pan_then_hold", "dof": "shallow", "aperture": "f/2.8", "angle": "slightly_elevated"}, "lighting": {"key": {"color": "#FFD699", "type": "warm_industrial"}, "fill": {"color": "#B8C9E0", "opacity": 0.3, "type": "overhead_cool"}, "rim": {"color": "#C0C0C0", "opacity": 0.4, "type": "mold_edge_highlight"}, "materialGlow": {"color": "#FF8C42", "opacity": 0.2, "type": "molten_plastic"}}, "narrationSegments": ["part2_paradigm_shift_006", "part2_paradigm_shift_007"]}, "mediaAliases": {"defaultSrc": "veo/injection_molding_process.mp4", "backgroundSrc": "veo/injection_molding_process.mp4", "outputSrc": "veo/injection_molding_process.mp4", "baseSrc": "veo/injection_molding_process.mp4"}, "overlayConfig": null, "renderMode": "raw-media"},
