...
const VISUAL_MEDIA: Record<string, Record<string, string>> = {
  "01_section_title_card": { defaultSrc: "veo/developer_prompt_shift.mp4", backgroundSrc: "veo/developer_prompt_shift.mp4", outputSrc: "veo/developer_prompt_shift.mp4", baseSrc: "veo/developer_prompt_shift.mp4" },
  ...
  "05_mold_defect_fix": { defaultSrc: "veo/defect_fix_the_mold.mp4", backgroundSrc: "veo/defect_fix_the_mold.mp4", outputSrc: "veo/defect_fix_the_mold.mp4", baseSrc: "veo/defect_fix_the_mold.mp4" },
  "06_craftsman_vs_mold": { defaultSrc: "veo/mold_glow_finale.mp4", backgroundSrc: "veo/mold_glow_finale.mp4", outputSrc: "veo/mold_glow_finale.mp4", baseSrc: "veo/mold_glow_finale.mp4" },
  ...
  "12_abstraction_staircase": { defaultSrc: "veo/chip_design_history.mp4", backgroundSrc: "veo/chip_design_history.mp4", outputSrc: "veo/chip_design_history.mp4", baseSrc: "veo/chip_design_history.mp4" },
  "13_prompt_replaces_review": { defaultSrc: "veo/developer_prompt_shift.mp4", backgroundSrc: "veo/developer_prompt_shift.mp4", outputSrc: "veo/developer_prompt_shift.mp4", baseSrc: "veo/developer_prompt_shift.mp4" },
};
