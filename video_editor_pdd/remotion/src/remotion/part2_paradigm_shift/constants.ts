...
export const SECTION_DURATION_SECONDS = 228.117;
export const SECTION_DURATION_FRAMES = Math.ceil(SECTION_FPS * SECTION_DURATION_SECONDS);

const s2f = (seconds: number) => Math.round(seconds * SECTION_FPS);

export const BEATS = {
  VISUAL_00_START: s2f(182.065),
  VISUAL_00_END: s2f(183.493),
  VISUAL_01_START: s2f(183.493),
  VISUAL_01_END: s2f(185.635),
  VISUAL_02_START: s2f(185.635),
  VISUAL_02_END: s2f(188.491),
  VISUAL_03_START: s2f(188.491),
  VISUAL_03_END: s2f(193.489),
  VISUAL_04_START: s2f(193.489),
  VISUAL_04_END: s2f(199.201),
  VISUAL_05_START: s2f(199.201),
  VISUAL_05_END: s2f(201.700),
  VISUAL_06_START: s2f(201.700),
  VISUAL_06_END: s2f(208.126),
  VISUAL_07_START: s2f(208.126),
  VISUAL_07_END: s2f(212.410),
  VISUAL_08_START: s2f(212.410),
  VISUAL_08_END: s2f(218.122),
  VISUAL_09_START: s2f(218.122),
  VISUAL_09_END: s2f(223.833),
  VISUAL_10_START: s2f(223.833),
  VISUAL_10_END: s2f(228.117),
};
