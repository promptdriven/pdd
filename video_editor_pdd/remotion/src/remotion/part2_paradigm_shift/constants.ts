...
export const BEATS = {
  ...
  VISUAL_02_START: s2f(93.700),
  VISUAL_02_END: s2f(119.280),
  VISUAL_03_START: s2f(119.560),
  VISUAL_03_END: s2f(142.100),
  VISUAL_04_START: s2f(119.560),
  VISUAL_04_END: s2f(142.100),
  VISUAL_05_START: s2f(142.280),
  VISUAL_05_END: s2f(180.380),
  VISUAL_06_START: s2f(180.880),
  VISUAL_06_END: s2f(192.240),
  VISUAL_07_START: s2f(191.216),
  VISUAL_07_END: s2f(230.240),
  VISUAL_08_START: s2f(192.400),
  VISUAL_08_END: s2f(218.100),
  ...
  VISUAL_13_START: s2f(218.300),
  VISUAL_13_END: s2f(230.240),
  VISUAL_14_START: s2f(218.300),
  VISUAL_14_END: s2f(230.240),
  VISUAL_15_START: s2f(218.300),
  VISUAL_15_END: s2f(230.240),
};
...
export const VISUAL_SEQUENCE = [
  ...
  { start: BEATS.VISUAL_05_START, end: BEATS.VISUAL_05_END, id: "13_triple_synthesis_equivalence", desc: "13 triple synthesis equivalence", lane: 0 },
  { start: BEATS.VISUAL_06_START, end: BEATS.VISUAL_06_END, id: "14_synopsys_pdd_equivalence", desc: "14 synopsys pdd equivalence", lane: 0 },
  { start: BEATS.VISUAL_07_START, end: BEATS.VISUAL_07_END, id: "02_factory_floor_wide", desc: "02 factory floor wide", lane: 0 },
  { start: BEATS.VISUAL_08_START, end: BEATS.VISUAL_08_END, id: "15_abstraction_staircase", desc: "15 abstraction staircase", lane: 0 },
  ...
  { start: BEATS.VISUAL_15_START, end: BEATS.VISUAL_15_END, id: "18_prompt_mold_finale", desc: "18 prompt mold finale", lane: 0 },
];
