...
export const BEATS = {
  ...
  VISUAL_07_START: s2f(189.472),
  VISUAL_07_END: s2f(228.140),
  VISUAL_08_START: s2f(192.840),
  VISUAL_08_END: s2f(216.140),
  VISUAL_09_START: s2f(195.076),
  VISUAL_09_END: s2f(228.140),
  VISUAL_10_START: s2f(204.807),
  VISUAL_10_END: s2f(228.140),
  VISUAL_11_START: s2f(211.330),
  VISUAL_11_END: s2f(228.140),
  VISUAL_12_START: s2f(213.881),
  VISUAL_12_END: s2f(228.140),
  VISUAL_13_START: s2f(216.300),
  VISUAL_13_END: s2f(228.140),
  VISUAL_14_START: s2f(216.300),
