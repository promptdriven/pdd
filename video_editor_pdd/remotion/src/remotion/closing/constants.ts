...
export const BEATS = {
  ...
  VISUAL_04_END: s2f(15.380),
  VISUAL_05_START: s2f(15.680),
  VISUAL_05_END: s2f(18.820),
  VISUAL_06_START: s2f(16.069),
...
export const VISUAL_SEQUENCE = [
  { start: BEATS.VISUAL_00_START, end: BEATS.VISUAL_00_END, id: "01_sock_discard_callback", desc: "01 sock discard callback", lane: 0 },
  { start: BEATS.VISUAL_01_START, end: BEATS.VISUAL_01_END, id: "02_developer_regenerate_clip", desc: "02 developer regenerate clip", lane: 0 },
  { start: BEATS.VISUAL_02_START, end: BEATS.VISUAL_02_END, id: "03_pdd_bug_fix_terminal", desc: "03 pdd bug fix terminal", lane: 0 },
  ...
  { start: BEATS.VISUAL_06_START, end: BEATS.VISUAL_06_END, id: "08_final_title_card", desc: "08 final title card", lane: 1 },
  { start: BEATS.VISUAL_07_START, end: BEATS.VISUAL_07_END, id: "07_the_beat", desc: "07 the beat", lane: 0 },
];
