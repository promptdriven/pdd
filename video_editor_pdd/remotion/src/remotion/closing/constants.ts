...
export const BEATS = {
  ...
  VISUAL_00_END: s2f(12.280),
  VISUAL_01_START: s2f(0.000),
  VISUAL_01_END: s2f(2.600),
...
export const VISUAL_SEQUENCE = [
  { start: BEATS.VISUAL_00_START, end: BEATS.VISUAL_00_END, id: "02_code_regenerate_workflow", desc: "02 code regenerate workflow", lane: 0 },
  { start: BEATS.VISUAL_01_START, end: BEATS.VISUAL_01_END, id: "01_sock_callback_discard", desc: "01 sock callback discard", lane: 1 },
  { start: BEATS.VISUAL_02_START, end: BEATS.VISUAL_02_END, id: "03_developer_regenerate_clip", desc: "03 developer regenerate clip", lane: 1 },
  ...
  { start: BEATS.VISUAL_05_START, end: BEATS.VISUAL_05_END, id: "06_mold_glow_finale", desc: "06 mold glow finale", lane: 1 },
  { start: BEATS.VISUAL_06_START, end: BEATS.VISUAL_06_END, id: "07_the_beat", desc: "07 the beat", lane: 0 },
  { start: BEATS.VISUAL_07_START, end: BEATS.VISUAL_07_END, id: "08_final_title_card", desc: "08 final title card", lane: 1 },
];
