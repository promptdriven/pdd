...
const VISUAL_CONTRACTS: Record<string, Record<string, unknown> | null> = {
  ...
  "07_the_beat": {"specBaseName": "07_the_beat", "dataPoints": {"type": "dramatic_pause", "diagramId": "the_beat", "baseTriangle": "pdd_triangle", "ghostState": {"edgeOpacity": 0.08, "edgeWidth": 1, "nodeRadius": 12, "nodeOpacity": 0.06}, "singleParticle": {"from": [960, 650], "to": [960, 350], "glintY": 520, "glintPeakOpacity": 0.25}, "narration": null, "backgroundColor": "#060A12", "vignette": {"edgeOpacity": 0.5}, "narrationSegments": ["closing_006"]}, "overlayConfig": null, "renderMode": "raw-media"},
