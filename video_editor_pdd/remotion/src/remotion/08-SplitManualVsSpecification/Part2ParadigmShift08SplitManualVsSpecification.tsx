...
export const Part2ParadigmShift08SplitManualVsSpecification: React.FC = () => {
  ...
  // Backing panel: fades in 0→20, holds, fades out 330→360
  ...
  // Global fade-out for tints and labels
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A1628" }}>
      ...
      <AbsoluteFill>
        ...
        {/* "BEFORE" vertical label in left margin */}
        <div
          style={{
            position: "absolute",
            left: LAYOUT_X + 12,
        ...
        {/* "AFTER" vertical label in left margin */}
        <div
          style={{
            position: "absolute",
            left: LAYOUT_X + 12,
        ...
        {/* Horizontal divider with "THE SHIFT" pill */}
        <ShiftDivider />
