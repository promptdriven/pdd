...
export const SCAR_RED = '#F85149';
export const SCAR_YELLOW = '#D29922';
...
export const LINE_NUMBER_X_END = 190;
export const LINE_NUMBER_X_START = 160;
...
export const HIGHLIGHT_STAGGER_FRAMES = 8;
export const HIGHLIGHT_FADE_DURATION = 12;
export const HIGHLIGHTS_START_FRAME = 10;
export const SCAN_LINE_START_FRAME = 60;
export const SCAN_LINE_DURATION = 90;
export const DELIBERATE_BLINK_START_FRAME = 120;
...
// Line indices (0-based) that have patch scar highlights
...
export const PATCH_SCARS: PatchScar[] = [
  { lineIndex: 4, highlightColor: SCAR_RED, targetOpacity: 0.5 },
  { lineIndex: 9, highlightColor: SCAR_RED, targetOpacity: 0.5 },
  { lineIndex: 13, highlightColor: SCAR_YELLOW, targetOpacity: 0.4 },
  { lineIndex: 16, highlightColor: SCAR_RED, targetOpacity: 0.5 },
];
