...
export const SECTION_DURATION_SECONDS = 32.661;
export const SECTION_DURATION_FRAMES = Math.ceil(SECTION_FPS * SECTION_DURATION_SECONDS);

const s2f = (seconds: number) => Math.round(seconds * SECTION_FPS);

export const BEATS = {
  VISUAL_00_START: s2f(31.707),
  VISUAL_00_END: s2f(31.798),
  VISUAL_01_START: s2f(31.798),
  VISUAL_01_END: s2f(31.911),
  VISUAL_02_START: s2f(31.911),
  VISUAL_02_END: s2f(32.093),
  VISUAL_03_START: s2f(32.093),
  VISUAL_03_END: s2f(32.229),
  VISUAL_04_START: s2f(32.229),
  VISUAL_04_END: s2f(32.366),
  VISUAL_05_START: s2f(32.366),
  VISUAL_05_END: s2f(32.548),
  VISUAL_06_START: s2f(32.548),
  VISUAL_06_END: s2f(32.661),
};
