...
export const BEATS = {
  ...
  VISUAL_03_START: s2f(15.460),
  VISUAL_03_END: s2f(26.240),
  VISUAL_04_START: s2f(15.460),
  VISUAL_04_END: s2f(26.240),
  VISUAL_05_START: s2f(26.240),
...
export const VISUAL_SEQUENCE = [
  ...
  { start: BEATS.VISUAL_01_START, end: BEATS.VISUAL_01_END, id: "03_module_highlight_terminal", desc: "03 module highlight terminal", lane: 0 },
  { start: BEATS.VISUAL_02_START, end: BEATS.VISUAL_02_END, id: "02_legacy_codebase_reveal", desc: "02 legacy codebase reveal", lane: 1 },
  ...
  { start: BEATS.VISUAL_06_START, end: BEATS.VISUAL_06_END, id: "07_transition_to_closing", desc: "07 transition to closing", lane: 0 },
];
