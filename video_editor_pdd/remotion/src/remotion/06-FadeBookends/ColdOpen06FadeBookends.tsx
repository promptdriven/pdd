...
import { BG_COLOR, VEO_SRC } from "./constants";
 ...
 * - Fades in from solid black over ~1s (frames 0–30, easeOutQuad)
 * - Stays fully transparent through the middle
 * - Fades out to solid black over ~1s (frames 440–470, easeInQuad)
 *
 * The overlay sits at z-index 100 (topmost), above Veo footage,
