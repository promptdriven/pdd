...
export const defaultAnimationSection03KeyVisualBarChartProps = {};

export const AnimationSection03KeyVisualBarChart: React.FC = () => {
  return (
    <AbsoluteFill
      style={{
...
export default AnimationSection03KeyVisualBarChart;
