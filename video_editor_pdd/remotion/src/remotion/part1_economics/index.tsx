...
const VISUAL_MEDIA: Record<string, Record<string, string>> = {
  "09_patching_vs_regeneration_split": { leftSrc: "veo/developer_patching_montage.mp4", defaultSrc: "veo/developer_patching_montage.mp4", rightSrc: "veo/developer_prompt_shift.mp4", backgroundSrc: "veo/developer_patching_montage.mp4", outputSrc: "veo/developer_patching_montage.mp4", baseSrc: "veo/developer_patching_montage.mp4", revealSrc: "veo/developer_prompt_shift.mp4" },
  "12_developer_darning_split": { leftSrc: "veo/developer_cursor_edit.mp4", defaultSrc: "veo/developer_cursor_edit.mp4", backgroundSrc: "veo/darning_split_screen.mp4", rightSrc: "veo/darning_split_screen.mp4", outputSrc: "veo/developer_cursor_edit.mp4", baseSrc: "veo/developer_cursor_edit.mp4", revealSrc: "veo/darning_split_screen.mp4" },
