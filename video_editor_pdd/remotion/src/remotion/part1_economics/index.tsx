...
const VISUAL_MEDIA: Record<string, Record<string, string>> = {
  "12_developer_darning_split": { leftSrc: "veo/developer_cursor_edit.mp4", defaultSrc: "veo/developer_cursor_edit.mp4", backgroundSrc: "veo/developer_cursor_edit.mp4", outputSrc: "veo/developer_cursor_edit.mp4", baseSrc: "veo/developer_cursor_edit.mp4" },
...
const VISUAL_OVERLAYS: Record<string, Record<string, string | boolean | number>> = {
  ...
  "07_two_by_two_grid": { fadeInFrames: 40 },
  "09_patching_vs_regeneration_split": { fadeInFrames: 20 },
  "12_developer_darning_split": { fadeInFrames: 20 },
  "16_double_meter_insight": { fadeInFrames: 20 },
  "17_try_it_yourself": { fadeInFrames: 40 },
};
