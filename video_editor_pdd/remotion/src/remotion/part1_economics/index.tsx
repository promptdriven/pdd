...
const COMPONENT_MAP: Record<string, React.ComponentType<any>> = {
  "02_sock_price_chart": Part1Economics02SockPriceChart,
  "03_code_cost_chart": Part1Economics03CodeCostChart,
  "07_context_window_shrink": Part1Economics07ContextWindowShrink,
  "13_crossing_lines_moment": Part1Economics09CrossingLinesMoment,
  "19_double_meter_insight": Part1Economics10DoubleMeterInsight,
};

const VISUAL_DURATIONS: Record<string, number> = {
  "02_sock_price_chart": 720,
  "03_code_cost_chart": 1650,
  "07_context_window_shrink": 1560,
  "13_crossing_lines_moment": 750,
  "19_double_meter_insight": 750,
};

const VISUAL_MEDIA: Record<string, Record<string, string>> = {
  "14_split_developer_grandma": { defaultSrc: "veo/developer_cursor_p1.mp4", backgroundSrc: "veo/developer_cursor_p1.mp4", outputSrc: "veo/developer_cursor_p1.mp4", baseSrc: "veo/developer_cursor_p1.mp4" },
...
const VISUAL_CONTRACTS: Record<string, Record<string, unknown> | null> = {
  ...
  "09_two_by_two_grid": {"specBaseName": "09_two_by_two_grid", "dataPoints": {"type": "two_by_two_matrix", "chartId": "study_reconciliation_grid", "axes": {"x": {"labels": ["Greenfield", "Brownfield"]}, "y": {"labels": ["In-Distribution", "Out-of-Distribution"]}}, "quadrants": [{"position": "top-left", "color": "#5AAA6E", "label": "GitHub study: +55%", "source": "GitHub, 2022"}, {"position": "bottom-right", "color": "#EF4444", "label": "METR study: −19%", "source": "METR, 2025"}], "insightText": "Every study is correct. They just measured different quadrants.", "narrationSegments": ["part1_economics_019"]}, "mediaAliases": {}, "overlayConfig": {"fadeInFrames": 45}, "renderMode": "generated-media"},
  ...
  "18_key_insight_stillness": {"specBaseName": "18_key_insight_stillness", "dataPoints": {"type": "stillness_beat", "style": "3b1b_key_insight", "backgroundColor": "#050810", "text": "So let me put together what I just showed you.", "textColor": "#94A3B8", "textOpacity": 0.6, "purpose": "Palate cleanser before key insight synthesis"}, "mediaAliases": {}, "overlayConfig": {"fadeOutFrames": 60}, "renderMode": "generated-media"},
