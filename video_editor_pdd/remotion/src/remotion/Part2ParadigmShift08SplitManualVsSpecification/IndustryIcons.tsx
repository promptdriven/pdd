...
export const NeedleThreadIcon: React.FC<IconProps> = ({ size, color }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    {/* Needle */}
    <line x1="16" y1="48" x2="44" y2="12" stroke={color} strokeWidth={2.5} strokeLinecap="round" />
...
export const HandsSculptingIcon: React.FC<IconProps> = ({ size, color }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    ...
    {/* Right hand */}
    <path
      d="M54 30C54 30 50 28 46 32L44 36"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
    />
...
export const PencilRulerIcon: React.FC<IconProps> = ({ size, color }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    ...
    {/* Ruler */}
    <rect x="36" y="22" width="6" height="34" rx="1" stroke={color} strokeWidth={2} transform="rotate(-20 39 39)" />
...
export const InjectionMoldIcon: React.FC<IconProps> = ({ size, color }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    ...
    {/* Arrows showing press direction */}
...
export const CodeTerminalIcon: React.FC<IconProps> = ({ size, color }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    ...
    {/* Code lines */}
    <path d="M16 30L22 34L16 38" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
