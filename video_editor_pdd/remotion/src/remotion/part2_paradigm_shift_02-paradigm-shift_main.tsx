...
export const Part2ParadigmShift02-paradigm-shiftMain: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A1628", justifyContent: "center", alignItems: "center" }}>
      ...
      <div style={{
        ...
        part2 paradigm shift 02-paradigm-shift
      </div>
    </AbsoluteFill>
  );
};

export default Part2ParadigmShift02-paradigm-shiftMain;
