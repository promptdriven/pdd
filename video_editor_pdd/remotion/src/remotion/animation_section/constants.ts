...
export const SECTION_DURATION_SECONDS = 10.944;
...
export const BEATS = {
  ...
  VISUAL_00_END: s2f(1.094),
  VISUAL_01_START: s2f(1.094),
  VISUAL_01_END: s2f(2.918),
  VISUAL_02_START: s2f(2.918),
  VISUAL_02_END: s2f(4.742),
  VISUAL_03_START: s2f(4.742),
  VISUAL_03_END: s2f(6.566),
  VISUAL_04_START: s2f(6.566),
  VISUAL_04_END: s2f(8.390),
  VISUAL_05_START: s2f(8.390),
  VISUAL_05_END: s2f(9.850),
  VISUAL_06_START: s2f(9.850),
  VISUAL_06_END: s2f(10.944),
};
