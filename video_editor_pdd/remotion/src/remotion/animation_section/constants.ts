...
export const SECTION_DURATION_SECONDS = 4.180;
...
export const BEATS = {
  ...
  VISUAL_00_END: s2f(1.393),
  VISUAL_01_START: s2f(1.393),
  VISUAL_01_END: s2f(2.787),
  VISUAL_02_START: s2f(2.787),
  VISUAL_02_END: s2f(4.180),
};
