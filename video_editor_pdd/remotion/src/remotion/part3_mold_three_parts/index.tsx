...
const VISUAL_MEDIA: Record<string, Record<string, string>> = {
  ...
  "08_traditional_vs_pdd_split": { leftSrc: "veo/bug_adds_wall.mp4", defaultSrc: "veo/bug_adds_wall.mp4", rightSrc: "veo/bug_adds_wall.mp4", backgroundSrc: "veo/bug_adds_wall.mp4", outputSrc: "veo/bug_adds_wall.mp4", baseSrc: "veo/bug_adds_wall.mp4" },
  "09_bug_fork_diagram": { defaultSrc: "veo/defect_fix_the_mold.mp4", backgroundSrc: "veo/defect_fix_the_mold.mp4", outputSrc: "veo/defect_fix_the_mold.mp4", baseSrc: "veo/defect_fix_the_mold.mp4" },
  "15_context_window_comparison": { rightSrc: "veo/developer_prompt_shift.mp4", defaultSrc: "veo/developer_prompt_shift.mp4", backgroundSrc: "veo/developer_prompt_shift.mp4", outputSrc: "veo/developer_prompt_shift.mp4", baseSrc: "veo/developer_prompt_shift.mp4" },
