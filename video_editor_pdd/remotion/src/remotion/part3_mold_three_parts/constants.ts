...
export const SECTION_DURATION_SECONDS = 344.397;
export const SECTION_DURATION_FRAMES = Math.ceil(SECTION_FPS * SECTION_DURATION_SECONDS);

const s2f = (seconds: number) => Math.round(seconds * SECTION_FPS);

export const BEATS = {
  VISUAL_00_START: s2f(251.997),
  VISUAL_00_END: s2f(253.290),
  VISUAL_01_START: s2f(253.290),
  VISUAL_01_END: s2f(256.521),
  VISUAL_02_START: s2f(256.521),
  VISUAL_02_END: s2f(260.397),
  VISUAL_03_START: s2f(260.397),
  VISUAL_03_END: s2f(265.244),
  VISUAL_04_START: s2f(265.244),
  VISUAL_04_END: s2f(267.828),
  VISUAL_05_START: s2f(267.828),
  VISUAL_05_END: s2f(272.997),
  VISUAL_06_START: s2f(272.997),
  VISUAL_06_END: s2f(300.459),
  VISUAL_07_START: s2f(300.459),
  VISUAL_07_END: s2f(329.535),
  VISUAL_08_START: s2f(329.535),
  VISUAL_08_END: s2f(339.227),
  VISUAL_09_START: s2f(339.227),
  VISUAL_09_END: s2f(344.397),
};
