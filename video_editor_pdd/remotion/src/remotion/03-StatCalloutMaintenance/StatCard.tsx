  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <DashIcon color={DETAIL_BLUE} size={ICON_SIZE} />
          {DETAIL_1_TEXT}
        </div>

        {/* Detail row 2: Not launch */}
        <div
          style={{
            fontFamily: "Inter, sans-serif",
            fontWeight: 600,
        ...
        >
          <DashIcon color={DETAIL_GREEN} size={ICON_SIZE} />
          {DETAIL_2_TEXT}
        </div>
