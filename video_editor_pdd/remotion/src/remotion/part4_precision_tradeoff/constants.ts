...
export const SECTION_DURATION_SECONDS = 112.001;
export const SECTION_DURATION_FRAMES = Math.ceil(SECTION_FPS * SECTION_DURATION_SECONDS);

const s2f = (seconds: number) => Math.round(seconds * SECTION_FPS);

export const BEATS = {
  VISUAL_00_START: s2f(103.000),
  VISUAL_00_END: s2f(103.371),
  VISUAL_01_START: s2f(103.371),
  VISUAL_01_END: s2f(105.227),
  VISUAL_02_START: s2f(105.227),
  VISUAL_02_END: s2f(106.619),
  VISUAL_03_START: s2f(106.619),
  VISUAL_03_END: s2f(107.918),
  VISUAL_04_START: s2f(107.918),
  VISUAL_04_END: s2f(108.846),
  VISUAL_05_START: s2f(108.846),
  VISUAL_05_END: s2f(109.402),
  VISUAL_06_START: s2f(109.402),
  VISUAL_06_END: s2f(110.887),
  VISUAL_07_START: s2f(110.887),
  VISUAL_07_END: s2f(112.001),
};
