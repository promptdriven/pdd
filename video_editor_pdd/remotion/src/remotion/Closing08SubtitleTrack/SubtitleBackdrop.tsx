...
export const SubtitleBackdrop: React.FC = () => {
  ...
  // Spec: fade in 0→0.6 over 15 frames at start
  // Spec: fade out from frame (end-60) to (end-15)
  const fadeOutStart = subtitleDuration - FADE_OUT_START_BEFORE_END;
  const fadeOutEnd = subtitleDuration - FADE_OUT_END_BEFORE_END;

  const opacity = interpolate(
    frame,
    [0, TRACK_FADE_IN_FRAMES, fadeOutStart, fadeOutEnd],
    [0, 0.6, 0.6, 0],
    {
