...
const VISUAL_MEDIA: Record<string, Record<string, string>> = {
  ...
  "07_split_ocean_forest": { leftSrc: "veo/forest_canopy_aerial.mp4", rightSrc: "veo/ocean_wave_sunset.mp4", defaultSrc: "veo/ocean_wave_sunset.mp4", backgroundSrc: "veo/ocean_wave_sunset.mp4", outputSrc: "veo/ocean_wave_sunset.mp4", baseSrc: "veo/ocean_wave_sunset.mp4", revealSrc: "veo/forest_canopy_aerial.mp4" },
  ...
  "12_split_ocean_forest_reprise": { defaultSrc: "veo/forest_canopy_aerial.mp4", backgroundSrc: "veo/forest_canopy_aerial.mp4", outputSrc: "veo/forest_canopy_aerial.mp4", baseSrc: "veo/forest_canopy_aerial.mp4", leftSrc: "veo/forest_canopy_aerial.mp4", rightSrc: "veo/ocean_wave_sunset.mp4", revealSrc: "veo/ocean_wave_sunset.mp4" },
