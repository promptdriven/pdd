...
export const MAIN_FONT_SIZE = 32;
...
export const CONNECTING_END = 150; // 30 frame draw
export const SUBTITLE_START = 180;
export const SUBTITLE_END = 210; // 30 frame fade
export const HOLD_START = 240;
export const HOLD_END = 330;
export const FADEOUT_START = 330;
export const FADEOUT_END = 390;

// Character delay for type-in effect (frames per character)
export const CHAR_DELAY = 2;
...
export const LINE1_SEGMENTS: TextSegment[] = [
  { text: "Synopsys: ", color: SYNOPSYS_ACCENT, weight: 700 },
  { text: "specification in → verified hardware out.", color: BODY_TEXT_COLOR, weight: 400 },
];

export const LINE2_SEGMENTS: TextSegment[] = [
  { text: "PDD: ", color: PDD_ACCENT, weight: 700 },
  { text: "prompt in → verified software out.", color: BODY_TEXT_COLOR, weight: 400 },
];

// Arrow color override for the → character
