...
const PREVIEW_VISUAL_CONTRACTS: Record<string, Record<string, unknown> | null> = {
  "animation_section:animation_section_01_title_card": {"specBaseName": "01_title_card", "dataPoints": {"series": [{"label": "A", "value": 1}, {"label": "B", "value": 2}]}, "overlayConfig": null},
  "animation_section:animation_section_02_key_visual": {"specBaseName": "02_key_visual", "dataPoints": {"series": [{"label": "A", "value": 1}, {"label": "B", "value": 2}]}, "overlayConfig": null},
  "animation_section:animation_section_03_split_summary": {"specBaseName": "03_split_summary", "dataPoints": {"series": [{"label": "A", "value": 1}, {"label": "B", "value": 2}]}, "overlayConfig": null},
  "veo_section:veo_section_01_title_card": {"specBaseName": "01_title_card", "dataPoints": {"series": [{"label": "A", "value": 1}, {"label": "B", "value": 2}]}, "overlayConfig": null},
  "veo_section:veo_section_02_key_visual": {"specBaseName": "02_key_visual", "dataPoints": {"series": [{"label": "A", "value": 1}, {"label": "B", "value": 2}]}, "overlayConfig": null},
  "veo_section:veo_section_03_split_summary": {"specBaseName": "03_split_summary", "dataPoints": {"series": [{"label": "A", "value": 1}, {"label": "B", "value": 2}]}, "overlayConfig": null},
};
