...
const PREVIEW_VISUAL_MEDIA: Record<string, Record<string, string>> = {
  ...
  "veo_section:05_split_nature_comparison": { defaultSrc: "veo/03_aerial_forest_canopy.mp4", backgroundSrc: "veo/03_aerial_forest_canopy.mp4", outputSrc: "veo/03_aerial_forest_canopy.mp4", baseSrc: "veo/03_aerial_forest_canopy.mp4" },
  "veo_section:06_veo_pipeline_infographic": { defaultSrc: "veo/03_aerial_forest_canopy.mp4", backgroundSrc: "veo/03_aerial_forest_canopy.mp4", outputSrc: "veo/03_aerial_forest_canopy.mp4", baseSrc: "veo/03_aerial_forest_canopy.mp4" },
  "veo_section:07_narration_overlay_intro": { defaultSrc: "veo/03_aerial_forest_canopy.mp4", backgroundSrc: "veo/03_aerial_forest_canopy.mp4", outputSrc: "veo/03_aerial_forest_canopy.mp4", baseSrc: "veo/03_aerial_forest_canopy.mp4" },
  "veo_section:08_section_end_card": { defaultSrc: "veo/03_aerial_forest_canopy.mp4", backgroundSrc: "veo/03_aerial_forest_canopy.mp4", outputSrc: "veo/03_aerial_forest_canopy.mp4", baseSrc: "veo/03_aerial_forest_canopy.mp4" },
};
