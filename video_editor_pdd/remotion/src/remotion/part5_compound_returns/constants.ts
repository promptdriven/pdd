...
export const SECTION_DURATION_SECONDS = 124.880;
...
export const BEATS = {
  ...
  VISUAL_00_END: s2f(29.840),
  VISUAL_01_START: s2f(0.000),
  VISUAL_01_END: s2f(29.840),
  VISUAL_02_START: s2f(29.840),
  VISUAL_02_END: s2f(49.540),
  VISUAL_03_START: s2f(49.880),
  VISUAL_03_END: s2f(72.040),
  VISUAL_04_START: s2f(72.460),
  VISUAL_04_END: s2f(81.740),
  VISUAL_05_START: s2f(94.940),
  VISUAL_05_END: s2f(103.220),
  VISUAL_06_START: s2f(103.220),
  VISUAL_06_END: s2f(124.880),
  VISUAL_07_START: s2f(114.946),
  VISUAL_07_END: s2f(124.880),
  VISUAL_08_START: s2f(115.630),
  VISUAL_08_END: s2f(124.880),
};
