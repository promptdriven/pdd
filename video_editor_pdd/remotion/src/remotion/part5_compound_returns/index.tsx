...
const VISUAL_OVERLAYS: Record<string, Record<string, string | boolean | number>> = {
  "02_maintenance_pie_chart": { fadeInFrames: 30 },
  "03_compound_debt_curve": { gradientOverlay: "bottom", fadeInFrames: 60 },
  "06_grandmother_socks_callback": { fadeInFrames: 15, fadeOutFrames: 30 },
  "07_developer_cursor_callback": { fadeInFrames: 15, fadeOutFrames: 30 },
  "09_contrarian_quote_card": { fadeOutFrames: 60 },
};
