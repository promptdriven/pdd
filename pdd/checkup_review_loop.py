...
- If the issue, PR, or split contract defines an allowed write set, compare
  every PR diff path against that set. Any out-of-scope path that remains
  without an explicit companion-artifact justification is a blocking finding.
