...
complete -c pdd -n "__fish_seen_subcommand_from checkup" -l max-review-cost -x -d "Deprecated/report-only: total review-loop LLM cost (USD); telemetry only, no longer stops the loop"
