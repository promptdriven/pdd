...
# protected base must establish an exact dormant rule first.  These reviewed
# one-time rollout paths are bound to this repository identity and exact paths.
# Keeping the tuple in code makes the bootstrap auditable and prevents a
# candidate from broadening it with a wildcard, parent directory, or altered
# owner/inventory fields.
