...
@click.option("--output-dir", default=None, help="Target subdirectory for new project (agentic mode only).")
@click.option("--force-single", is_flag=True, default=False, help="Force single-project generation even if PRD is complex (skip complexity check).")
@click.pass_context
