...
@click.pass_context
def cli(ctx, force: bool, strength: float, temperature: float, verbose: bool, quiet: bool, output_cost: Optional[str]):
...
def fix(ctx, prompt_file: str, code_file: str, unit_test_file: str, error_file: str,
        ...
        loop: bool, verification_program: Optional[str], max_attempts: int, budget: float) -> Tuple[bool, str, str, int, float, str]:
...
@click.pass_context
@track_cost
def update(ctx, input_prompt_file: str, input_code_file: str, modified_code_file: str, output: Optional[str]) -> Tuple[str, float, str]:
