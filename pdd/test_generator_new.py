...
def test_generator(prompt: str, code: str, strength: float, temperature: float, language: str) -> tuple[str, float]:
    ...
    :param strength: The strength parameter for the model selection.
    :param temperature: The temperature parameter for the model selection.
    :param language: The programming language of the code.
    :return: A tuple containing the generated unit test code and the total cost of the operation.
    """
    try:
