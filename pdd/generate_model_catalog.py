...
_MANDATORY_MODEL_ROWS: List[Dict[str, Any]] = [
    ...
    # Gemini 3.6 Flash and Gemini 3.5 Flash-Lite launched GA on 2026-07-21.
    # Seed both official Gemini API and Vertex routes until LiteLLM's bundled
    # registry catches up. No reviewed Arena/DeepSWE scores exist yet, so these
    # use explicit zero-valued platform-default ranks rather than fabricated
    # benchmark values. Prices and token limits come from Google's launch docs.
    {
