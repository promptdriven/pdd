...
* [`pdd` Command:  Basic Usage and Subcommands Overview](#basic-usage) - PDD subcommands and options
  * [Global `pdd` Options](#global-options)
  * [Supported Programming Languages](#supported-programming-languages)
  * [Prompt File Naming Convention](#prompt-file-naming-convention)
  * [Error Handling](#error-handling)
  * [Core Dump Debug Bundles](#core-dump-debug-bundles)
  * [Context Selection Flags](#context-selection-flags)
  * [Auto-Update Control](#auto-update-control)
  * [AI Model Information](#ai-model-information)
  * [Output Cost Tracking](#output-cost-tracking)
  * [Detailed `pdd` sub-commands sections](#pdd-sub-commands)
* [VS Code extension](#vs-code-extension)
* [MCP server](#mcp-server-for-agentic-clients)
* [update_model_costs.py](#update-llm-model-data-pddupdate_model_costspy)
...
Here is a brief overview of the main commands provided by PDD. 

**Click the command name** to jump to its detailed section:

### Sync - the "do-it-all" command
- **[`sync`](#1-sync)**: Automatically executes the complete PDD workflow loop for a given output file basename - from prompt improvement (including dependency injection) through code generation, testing, and verification.

### Main PDD workflow commands
...
<a name="supported-programming-languages"></a>
...
<a name="prompt-file-naming-convention"></a>
...
<a name="core-dump-debug-bundles"></a>
...
<a name="context-selection-flags"></a>
...
<a name="mcp-server-for-agentic-clients"></a>
...
<a name="update-llm-model-data-pddupdate_model_costspy"></a>
