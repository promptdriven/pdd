...
def main() -> None:
    ...
    2. Detect installed CLI harnesses (claude, gemini, codex, opencode)
    ...
    # for r in results:
    #     r.cli_name           -> "claude" | "gemini" | "codex" | "opencode" | ""
    #     r.provider           -> "anthropic" | "google" | "openai" | "opencode" | ""
    ...
    #   2. Gemini CLI   ✗ Not found                         ✓ GEMINI_API_KEY is set
    #   3. Codex CLI    ✗ Not found                         ✗ OPENAI_API_KEY not set
    #   4. OpenCode CLI ✓ Found at /usr/local/bin/opencode  ✓ provider credentials found
    #
