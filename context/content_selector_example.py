...
Selector kinds:
    ...
    path:key        JSON/YAML top-level key (requires .json/.yaml/.yml file_path)
    path:key.child  Dot-notation traversal into nested objects
    path:key[0]     Array index access (0-based)
    path:key[0].x   Array index followed by dot traversal
...
def main() -> None:
    ...
    # ==================================================================
    # Example 7: JSON path selector
    # ==================================================================
    separator("Example 7: JSON path selectors")
    ...
    result = ContentSelector.select(
        content=SAMPLE_JSON,
        selectors=["path:dependencies.rich"],
        file_path="project.json",
    )
    print("path:dependencies.rich →")
    print(result)
    print()
    ...
    result = ContentSelector.select(
        content=SAMPLE_JSON,
        selectors=["path:scripts[0]"],
        file_path="project.json",
    )
    print("path:scripts[0] →")
    print(result)
    print()

    # Array index + dot traversal
    result = ContentSelector.select(
        content=SAMPLE_JSON,
        selectors=["path:scripts[1].command"],
        file_path="project.json",
    )
    print("path:scripts[1].command →")
    print(result)
    print()
    ...
    result = ContentSelector.select(
        content=SAMPLE_JSON,
        selectors=["path:dependencies"],
        file_path="project.json",
    )
    print("path:dependencies (whole object) →")
    print(result)
    print()
    ...
    try:
        ContentSelector.select(
            content=SAMPLE_JSON,
            selectors=["path:nonexistent"],
            file_path="project.json",
        )
    except SelectorError as exc:
        print(f"Caught SelectorError for missing JSON path:\n  {exc}")

    # ==================================================================
    # Example 8: YAML path selector
    # ==================================================================
    separator("Example 8: YAML path selectors")
    ...
    result = ContentSelector.select(
        content=SAMPLE_YAML,
        selectors=["path:database.host"],
        file_path="config.yaml",
    )
    print("path:database.host →")
    print(result)
    print()
    ...
    result = ContentSelector.select(
        content=SAMPLE_YAML,
        selectors=["path:environments[1].url"],
        file_path="config.yml",
    )
    print("path:environments[1].url →")
    print(result)

    # ==================================================================
    # Example 9: Multiple selectors combined
    # ==================================================================
    separator("Example 9: Multiple selectors (union of results)")
    ...
    # ==================================================================
    # Example 10: Interface mode – signatures & docstrings only
    # ==================================================================
    separator("Example 10: Interface mode (mode='interface')")
    ...
    # ==================================================================
    # Example 11: Interface mode with a specific class selector
    # ==================================================================
    separator("Example 11: Interface mode for a specific class")
    ...
    # ==================================================================
    # Example 12: Error handling – malformed selector
    # ==================================================================
    separator("Example 12: Error handling")
    ...
    # ==================================================================
    # Example 13: No file_path – defaults to Python for AST selectors
    # ==================================================================
    separator("Example 13: No file_path (defaults to Python)")
