...
def main():
    ...
    print("\nTesting run_checkup_review_loop...")
    ...
    with patch("pdd.checkup_review_loop.run_agentic_task") as mock_run:
        # Mock the primary reviewer run
        mock_run.return_value = (True, "Findings: none", 0.01, "codex")
        
        with patch("pdd.checkup_review_loop._setup_pr_worktree") as mock_setup:
            mock_setup.return_value = (Path("/tmp/worktree"), None)
