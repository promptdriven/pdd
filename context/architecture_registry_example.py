...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("\n[1] Tier A wins over enclosing .git")
        ...
        empty.mkdir()
        print("\n[4] No markers -> returns the resolved start directory")
        print(f"    cwd                = {empty}")
