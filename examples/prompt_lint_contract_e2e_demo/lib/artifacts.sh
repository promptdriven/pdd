#!/usr/bin/env bash
# Shared artifact helpers for the contract E2E demo (sourced, not executed alone).
#
#   source "$DEMO_DIR/lib/artifacts.sh"
#   artifact_init_dirs
#   artifact_save "prompts/foo_work_python.prompt" "prompt_clarified.prompt"
#   artifact_diff "reports/artifacts/a.prompt" "reports/artifacts/b.prompt" \
#       "reports/diffs/a_vs_b.diff" "a.prompt" "b.prompt"
